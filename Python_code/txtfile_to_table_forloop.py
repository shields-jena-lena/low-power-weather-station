...
"""
 ...
 multiple in one batch. Meant to run whole script in one go, before hand check 
 that the wind vane values separate the sections with the commented out section
 at the bottom 
 Author: Jena Shields
...
nums = [3, 4, 5, 6, 7]
n_nums = len(nums) #number of weather stations
...
#%% check that binning works for wind vane for each station
"""
num = 7 #number of station of interest
